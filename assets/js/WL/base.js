...
function chart4(data, type, chartType) {
    ...
    // 移除所有射线效果，改为地区发光效果
    // 不再添加lines和effectScatter，只保留地图本身的发光效果
    ...
    var option = {
        ...
        geo: {
            ...
            itemStyle: {
                ...
                emphasis: {
                    areaColor: 'rgba(135, 206, 235, 0.3)',
                    borderColor: '#87ceeb',
                    shadowBlur: 20,
                    shadowColor: '#87ceeb'
                }
            ...
            regions: [
                {
                    name: '广东',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.4)',
                        borderColor: '#00bfff',
                        shadowBlur: 50,
                        shadowColor: '#00bfff',
                        shadowOffsetX: 0,
                ...
                },
                {
                    name: '江苏',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.35)',
                        borderColor: '#00bfff',
                        shadowBlur: 45,
                        shadowColor: '#00bfff'
                    }
                },
                {
                    name: '浙江',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.38)',
                        borderColor: '#00bfff',
                        shadowBlur: 47,
                        shadowColor: '#00bfff'
                    }
                },
                {
                    name: '上海',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.5)',
                        borderColor: '#00bfff',
                        shadowBlur: 55,
                        shadowColor: '#00bfff'
                    }
                },
                {
                    name: '北京',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.45)',
                        borderColor: '#00bfff',
                        shadowBlur: 52,
                        shadowColor: '#00bfff'
                    }
                ...
                },
                {
                    name: '河南',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.28)',
                        borderColor: '#00bfff',
                        shadowBlur: 38,
                        shadowColor: '#00bfff'
                    }
                },
                {
                    name: '湖北',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.32)',
                        borderColor: '#00bfff',
                        shadowBlur: 42,
                        shadowColor: '#00bfff'
                    }
                ...
                },
                {
                    name: '福建',
                    itemStyle: {
                        areaColor: 'rgba(135, 206, 235, 0.33)',
                        borderColor: '#00bfff',
                        shadowBlur: 43,
                        shadowColor: '#00bfff'
                    }
